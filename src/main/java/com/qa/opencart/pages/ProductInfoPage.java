...
public class ProductInfoPage {
    ...
    public int getProductImageCount() {
        int actualProductImagesCount = eleUtil.waitForElementsVisible(productImages, AppConstants.MEDIUM_TIME_OUT).size();
        System.out.println("total product images for : " + getProductHeaderValue() + "===>" + actualProductImagesCount);
    ...
    public Map<String, String> getProductData() {
        productMap = new HashMap<String, String>(); //unorderd
        //productMap = new LinkedHashMap<String, String>();////ordered
        //productMap = new TreeMap<String, String>();//Alphabatically /maintain sorting order
